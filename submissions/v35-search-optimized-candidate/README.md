# V35: Search-Optimized Classical Candidate

V35 snapshots the verified V34 continuation: constant-time bit scans, earlier safe TT cutoffs,
and pinned-defender-aware SEE on the team's tested V29 board substrate. Historical V34 evidence
and paths are retained below for provenance. V35 is a candidate, not a claim of perfect play or
a guaranteed competition winner.
